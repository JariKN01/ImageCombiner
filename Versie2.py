...
def paste_center(base_image_path, overlay_images_dir, output_dir, max_overlay_width, max_overlay_height):
    ...
    for overlay_image_path in overlay_image_paths:
        ...
        # Determine the output path with the same name as the overlay image but with .jpg extension
        output_image_path = os.path.join(output_dir, f"{overlay_image_name}.jpg")
...
# Usage of the script
base_image_path = "C:/Users/jarik/ProductDescription/ImageCombiner/base-image/base.jpg"  # Replace with the path to your base image
overlay_images_dir = "C:/Users/jarik/ProductDescription/ImageCombiner/Transparante_Afbeeldingen"  # Replace with the directory containing your overlay images
output_dir = "C:/Users/jarik/ProductDescription/ImageCombiner/resultaat"  # Ensure this is the directory where you want to save your output images
